...
export const enUS: TranslationKeys = {
  ...
  "generalSettings.analytics": "Anonymous Usage Statistics",
  "generalSettings.analyticsDesc": "Only counts anonymous installs and launch activity; no database content is uploaded",
  ...
  "ai.statusLoadingSchema": "Preparing database context...",
  "ai.statusCallingAI": "Planning next step...",
  "ai.statusWaitingModel": "Waiting for model response...",
  ...
  "ai.toolEventArgs": "Arguments ready",
  ...
  "ai.stepThinkingRunning": "Analyzing",
  "ai.stepThinkingDone": "Thinking process",
  "ai.stepObservation": "Read result",
  "ai.stepObservationError": "Call failed",
  "ai.stepToolTableFuzzyMatch": "Match tables {target}",
  "ai.stepToolTableDescribe": "Inspect schema {target}",
  "ai.stepToolTableDDL": "View DDL {target}",
  "ai.stepToolTableStats": "View table stats {target}",
  "ai.stepToolTableSample": "Sample table rows {target}",
  "ai.stepToolTableProfile": "Profile columns {target}",
  "ai.stepToolSQLExplainPlan": "View explain plan",
  "ai.stepToolSQLReadonly": "Run read-only SQL",
  "ai.stepToolGeneric": "Call tool {tool}",
  "ai.stepNoDetails": "No details",
  ...
  // ====== Status Bar ======
  "statusBar.schemaIndex": "Schema Index",
  "statusBar.schemaState": "State",
  "statusBar.schemaReady": "Ready",
  "statusBar.schemaRefreshing": "Refreshing",
  "statusBar.schemaStale": "Stale",
  "statusBar.schemaError": "Refresh Failed",
  "statusBar.schemaMissing": "Missing",
  "statusBar.schemaDirty": "Schema Changed",
  "statusBar.lastRefreshed": "Last Refreshed",
  "statusBar.indexedTables": "Indexed Tables",
  "statusBar.schemaSource": "Source",
  "statusBar.refreshSchemaIndex": "Refresh Now",
