...
export const enUS: TranslationKeys = {
  ...
  "ai.statusPlanningTools": "Planning and invoking tools...",
  "ai.statusCallingAI": "AI is generating...",
  "ai.statusExecutingSQL": "Executing SQL...",
  "ai.statusAutoFixing": "Auto-fixing SQL...",
  "ai.statusDone": "Completed",
  "ai.statusRoundPlanning": "Round {round}: planning next step",
  "ai.statusRoundRunning": "Round {round}: running tool {tool}",
  "ai.statusRoundCompleted": "Round {round}: completed",
  "ai.statusRoundError": "Round {round}: failed",
  "ai.statusToolLoopDone": "Tool loop complete, preparing final response",
  ...
  "ai.loopContinue": "Continue",
  "ai.loopFinalize": "Finalizing",
  "ai.loopError": "Error",
  "ai.loopRound": "Round {round}/{max}",
  "ai.executionTraceTitle": "Execution Trace",
  "ai.executionTraceIter": "Iterations",
  "ai.executionTraceChain": "Tool chain",
  "ai.executionTraceDuration": "Total duration",
