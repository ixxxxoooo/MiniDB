...
export const zhCN: TranslationKeys = {
  ...
  "ai.statusPlanningTools": "正在规划并调用工具...",
  "ai.statusCallingAI": "AI 正在分析生成...",
  "ai.statusExecutingSQL": "正在执行 SQL...",
  "ai.statusAutoFixing": "正在自动修复 SQL...",
  "ai.statusDone": "处理完成",
  "ai.statusRoundPlanning": "第 {round} 轮：规划下一步",
  "ai.statusRoundRunning": "第 {round} 轮：执行工具 {tool}",
  "ai.statusRoundCompleted": "第 {round} 轮：完成",
  "ai.statusRoundError": "第 {round} 轮：失败",
  "ai.statusToolLoopDone": "工具链规划结束，准备生成最终回复",
  ...
  "ai.thinkingLabel": "正在推理...",
  "ai.analysisLabel": "分析结果",
  "ai.loopContinue": "继续调用",
  "ai.loopFinalize": "准备回答",
  "ai.loopError": "出现错误",
  "ai.loopRound": "第 {round}/{max} 轮",
  "ai.executionTraceTitle": "执行轨迹",
  "ai.executionTraceIter": "迭代次数",
  "ai.executionTraceChain": "工具调用链",
  "ai.executionTraceDuration": "总耗时",
