...
export const zhCN: TranslationKeys = {
  ...
  "generalSettings.analytics": "匿名使用统计",
  "generalSettings.analyticsDesc": "仅统计匿名安装数和启动活跃，不上传数据库内容",
  ...
  "ai.stepToolTableSample": "抽样查看表数据 {target}",
  "ai.stepToolTableProfile": "生成字段画像 {target}",
  "ai.stepToolSQLExplainPlan": "查看执行计划",
